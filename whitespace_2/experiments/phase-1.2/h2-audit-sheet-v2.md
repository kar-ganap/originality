...
**Verdict:** FLAG: BAD_ABSTRACT (publisher chrome — "Views Icon Views ... Download citation file: Ris (Zotero) ... Search Advanced Search"; underlying chem-phys paper is real but the abstract field is unusable for embedding)
...
**Verdict:** FLAG: WRONG_FIELD (pure math, not sure whether that works for our purposes or not)
...
**Verdict:** FLAG: WRONG_FIELD (In Ukranian, organizational economics probably)
...
**Verdict:** FLAG: WRONG_FIELD (Possibly, a bit hard to say - it is application of math to medical instrumentation)
...
**Verdict:** FLAG: BORDERLINE (for Survey methodology, survey research etc. but can't verify since access is closed)
...
**Verdict:** FLAG: WRONG_FIELD (education research; `computer science (0.34)` is concept-tagger noise — no cs content in title or abstract)
...
**Verdict:** FLAG: BAD_ABSTRACT, WRONG_FIELD
...
**Verdict:** FLAG: WRONG_FIELD (philosophy) 
...
**Verdict:** FLAG: BORDERLINE (Some observational study)
...
**Verdict:** FLAG: BORDERLINE (Can't verify since the link is broken)
...
**Verdict:** FLAG: WRONG_FIELD (also junk title)
...
**Verdict:** FLAG: WRONG_FIELD (also junk abstract)
...
**Verdict:** FLAG: BORDERLINE (link is broken)
...
**Verdict:** FLAG: WRONG_FIELD (contribution is a dataset most likely)
...
**Verdict:** FLAG: WRONG_FIELD (bibliography)
...
**Verdict:** FLAG: BORDERLINE (almost Ok)
...
**Verdict:** OK (abstract not present)
...
**Verdict:** FLAG: WRONG_FIELD (commercial)
...
**Verdict:** FLAG: WRONG_FIELD (although can't be sure since can't access the link)
...
**Verdict:** FLAG: BORDERLINE (some application of mathematical framework)
...
**Verdict:** FLAG: BORDERLINE (not an original article)
...
**Verdict:** FLAG: BORDERLINE (not an original article - a book listing)
...
**Verdict:** FLAG: WRONG_FIELD (pure math)
...
**Verdict:** FLAG: WRONG_FIELD (also just abstract)
...
**Verdict:** FLAG: BORDERLINE (link broken)
...
**Verdict:** FLAG: WRONG_FIELD (sounds alarmist but real source)
...
**Verdict:** FLAG: WRONG_FIELD (almost junk - it seems like a commercial/ad)
...
**Verdict:** FLAG: BORDERLINE (Can't verify since link is broken)
...
**Verdict:** FLAG: WRONG_FIELD (Statistics)
---
