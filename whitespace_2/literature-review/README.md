...
| 03 | **Petersen, Arroyave & Pammolli 2024**, *QSS* 5(4), "The disruption index is biased by citation inflation" | Broader citation-inflation critique. **Positioning read (~2 hrs)** justifying CD-index exclusion. | draft (Discussion Notes pending) |
