...
- New layers / commitments added to the demographic-side or
  canonical-side three-layer defense → update diagram 9.
- New construct-validity audit framework introduced for any channel
  → update diagram 9 and the §14 framing layer.
